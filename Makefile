...
ACLOCAL = ${SHELL} /export/home/donaldo01/dev/bitcoin/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
...
ARM_SHANI_CXXFLAGS = 
AS = as
AUTOCONF = ${SHELL} /export/home/donaldo01/dev/bitcoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /export/home/donaldo01/dev/bitcoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /export/home/donaldo01/dev/bitcoin/build-aux/missing automake-1.16
AVX2_CXXFLAGS = -mavx -mavx2
AWK = gawk
BDB_CFLAGS = -I/export/home/donaldo01/dev/bitcoin/db4/include
BDB_CPPFLAGS = -I/export/home/donaldo01/dev/bitcoin/db4/include
BDB_LIBS = -L/export/home/donaldo01/dev/bitcoin/db4/lib -ldb_cxx-4.8
...
COV_TOOL_WRAPPER = 
CPP = clang -E
CPPFLAGS =  -DHAVE_BUILD_INFO -DPROVIDE_FUZZ_MAIN_FUNCTION
CXX = /usr/bin/ccache clang++ -std=c++17
CXXCPP = clang++ -std=c++17 -E
CXXDEPMODE = depmode=gcc3
CXXFLAGS = 
CYGPATH_W = echo
DEBUG_CPPFLAGS =  -DDEBUG -DDEBUG_LOCKORDER -DABORT_ON_FAILED_ASSUME -fmacro-prefix-map=$(abs_top_srcdir)=.
DEBUG_CXXFLAGS =  -O0 -g3 -ftrapv -fdebug-prefix-map=$(abs_top_srcdir)=.
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
DMG = 
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /export/home/donaldo01/dev/bitcoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
USE_UPNP = 
VERSION = 22.99.0
WARN_CXXFLAGS =  -Wall -Wextra -Wgnu -Wformat -Wformat-security -Wvla -Wshadow-field -Wthread-safety -Wrange-loop-analysis -Wredundant-decls -Wunused-member-function -Wdate-time -Wconditional-uninitialized -Woverloaded-virtual -Wunreachable-code-loop-increment -Wimplicit-fallthrough
WINDRES = 
...
ZMQ_LIBS = -lzmq
abs_builddir = /export/home/donaldo01/dev/bitcoin
abs_srcdir = /export/home/donaldo01/dev/bitcoin
abs_top_builddir = /export/home/donaldo01/dev/bitcoin
abs_top_srcdir = /export/home/donaldo01/dev/bitcoin
ac_ct_AR = ar
ac_ct_CC = clang
ac_ct_CXX = 
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /export/home/donaldo01/dev/bitcoin/build-aux/install-sh
