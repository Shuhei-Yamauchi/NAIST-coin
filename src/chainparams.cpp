...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1231006505, 2084279076, 0x207fffff, 1, 50 * COIN);
...
std::cout << "genesis.markele = " << genesis.hashMerkleRoot.ToString() << '\n';
//GetHash().ToString() << '\n';

        consensus.hashGenesisBlock = genesis.GetHash();
//        assert(consensus.hashGenesisBlock == uint256S("a4123ce6f25262a01cb400881ed6c34025d435b6af1777e313ca669e74062ba6"));
//        assert(genesis.hashMerkleRoot == uint256S("dc265cd092796ce931bd3febd956c4a69ca46c295ea5cc78dea9041131796ba3"));
...
//GetHash().ToString() << '\n';
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
   //     assert(consensus.hashGenesisBlock == uint256S("dde51c0d944b4f060cc547c06a959bf16e33853c73706549beb0aad0c8e41bc2"));
   //     assert(genesis.hashMerkleRoot == uint256S("2e9df162cb2e81ed543bc7af0375ad5bd67b2814ce9c0ef996ac9870d47463d5"));
...
//GetHash().ToString() << '\n';
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
   //     assert(consensus.hashGenesisBlock == uint256S("e4a4afd391947309fe6ca91c0bd840b4c24ce6a38a7fa91ca8957d08568fae8c"));
   //     assert(genesis.hashMerkleRoot == uint256S("183309721f07e3479e7f1f08bd533e0fe7fe5dc70ea5e2fcfb50acaa670103e7"));
...
//GetHash().ToString() << '\n';
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("79f96021f9f63b9be86ea2adf9031b9a96103b2e049b064461c389fad7e323db"));
        //assert(genesis.hashMerkleRoot == uint256S("a8987a42a8fc846a6f9831a7c76de904148931641585c6e8c91b223aa387e25c"));
