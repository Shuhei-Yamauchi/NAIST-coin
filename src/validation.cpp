...
std::cout << "[PreChecks]transactionTyp is " + ws.m_ptx.get()->transactionType + "\n" ;
...
if (tx.testMessage == "donaldo")
{
    std::cout<<"[Final]testMessage is ";
    std::cout<<tx.testMessage;
std::cout<<"\n";
}



std::cout << "[Final]transactionTyp is " + tx.transactionType + "\n";
...
static bool ContextualCheckBlock(const CBlock& block, BlockValidationState& state, const Consensus::Params& consensusParams, const CBlockIndex* pindexPrev)
{
    ...
    for (const auto& tx : block.vtx) {
            std::cout << "donaldo" << std::endl;
                std::cout << "[ContextualCheckBlock]address_to_is  " + tx->address_to + "\n";
    std::cout << "[ContextualCheckBlock]address_from_is " + tx->address_from + "\n";
...
bool CChainState::AcceptBlock(const std::shared_ptr<const CBlock>& pblock, BlockValidationState& state, CBlockIndex** ppindex, bool fRequested, const FlatFilePos* dbp, bool* fNewBlock)
{
    ...
    //shuhei yamauchi - pindex(ntx is transactions ? )
