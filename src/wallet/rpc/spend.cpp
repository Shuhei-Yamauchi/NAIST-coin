...
std::cout << "[SendMoney]transactionTyp is " + tx.get()->transactionType ;
...
RPCHelpMan asendtoaddress()
{
    return RPCHelpMan{"asendtoaddress",
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    const std::string address2 = request.params[1].get_str();
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    UniValue address_amounts(UniValue::VOBJ);
    const std::string address = "bcrt1qprlq5edvrm5xmsepttu7k88g7q82m6pfgj33vq";
    address_amounts.pushKV(address, 0.1);
    coin_control.m_max_depth = 8888888;
    UniValue subtractFeeFromAmount(UniValue::VARR);
    if (fSubtractFeeFromAmount) {
        subtractFeeFromAmount.push_back(address);
    }
